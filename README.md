...
- **Project Neurolis:** An autonomous 4WD humanoid robot integrating local real-time vision tracking + Ultrasonic obstacle detection + deviation, Arduino-based steer motor control, and conversational AI ( Using Groq API ).


### Contact me:

- Email: swapnil.legacy@gmail.com
- LinkedIn: [Swapnil Jai Chauhan](https://www.linkedin.com/in/swapnil-jai-chauhan-4733b13a0/)

<!--
**swapnil-jchauhan/swapnil-jchauhan** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
